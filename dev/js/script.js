...
const footerB = gE('footer-beneath');
const site = gE('site');
const footerBtnOpen = gE('btn-footer-beneath-open');
const footerBtnClose = gE('btn-footer-beneath-close');
...
.to(".mh-sidebar", .4, { width: "100%"})
.set([".mh-sidebar-menu .menu-item, .mh-sidebar .widget-location"], {opacity: 0, x: -20})
.set(".mh-sidebar-inner", {opacity: 1, display: 'inline-block'}, "+=.25")
.staggerTo(".mh-sidebar .menu-item", .3, {opacity: 1, x: 0}, .1 )
.to(".mh-sidebar .widget-location", .3, {opacity: 1, x: 0}, "+=.1")
;
